  ...
  <div id="wrapper">
          ...
          <div class="col-md-8">
            ...
            <form method="post">
              <div class="im1">
                ...
                <img class="img-responsive pull-left" src="buyer_login.png" style="height:200px; width:190px;"> 
					      <h3>Login : <b>Buyer</b></h3> 
	...
	<?php
       ...
       if(isset($_POST['submit']))
        ...
        $buyer_login_table = "SELECT username,password FROM buyer_signup WHERE username='$user' AND password='$pass'";
            
        $res = mysqli_query( $conn,$buyer_login_table ) ;
