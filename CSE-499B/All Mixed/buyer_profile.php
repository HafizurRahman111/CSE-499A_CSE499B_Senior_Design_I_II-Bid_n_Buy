    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         <h4 class="w3-center bold text-shadow: 2px 2px #FF0000">My Profile ( BUYER )</h4> 
         <hr></hr>
  ...
  if (isset($_POST['done'])) 
 {
   ...
   if (empty($Type)) 
     ...
     if (!isset($errors)) 
    {
        ...
        $sql = 'INSERT INTO buy_products_demand (buyer_username,buyer_name,buyer_email,buyer_phone,category,type,product_name,estimated_price,quantity,product_details) VALUES (?,?,?,?,?,?,?,?,?,?)';
      
        $statement = $conn->prepare($sql);

        $statement->bind_param('sssssssdss',$use,$buyerName,$buyerEmail,$buyerPhone,$pro_cat,$Type,$proName,$Price,$Quantity,$Details);
