        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
              ...
              <h2>Buy Your Quality Products</h2>
            </div>
          </div>
        </div>
      </div>
...
<?php 
   ...
   $sql = "SELECT * FROM sell_products_demand ORDER BY s_product_id DESC LIMIT 11,20";
                         ...
                         <div class='flip-card-front' >
                           <img src='images/icons/3.jpg'/".$row['image']."' alt='Avatar'style='width:150px;height:200px;''>
                              ...
                              <div class='flip-card-back'>
                                ...
                                <p><button class='btn btn-success btn-sm'>".$row['type']."</button></p>
...
<!-- PHP -->
            ...
            <div id="pagination">
              ...
              <a href="buyProduct.php" class="inactive">1</a>
