        ...
        <div class="row">
          ...
          <div class="span4">
            ...
            <aside class="left-sidebar">
              ...
              <iframe width="853" height="480" src="https://www.youtube.com/embed/J9thhWbFqLU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                </div>
              </div>
...
<?php 
   ...
   $sql = "SELECT * FROM sell_products_demand ORDER BY s_product_id DESC LIMIT 0,10";
                        ...
                        <div class='flip-card-inner' size='width:150px,height:170px'>
                         <div class='flip-card-front' >
                              ...
                              <div class='flip-card-back'>
                                ...
                                <p>Product ID : ".$row['s_product_id']."</p>
                                <p>Product Name : ".$row['product_name']."</p>
                                <p>Price : ".$row['estimated_price']."</p>
                                <p>Quantity : ".$row['quantity']."</p>

                              
                                <p><button class='btn btn-success btn-sm'><a href='product_details_page.php' >".$row['type']."</a></button></p>
...
?>
     ...
     <!--------------------------    PHP  ------------------------------>
            ...
            <div id="pagination">
              ...
              <a href="buyProduct_1.php" class="inactive">2</a>
